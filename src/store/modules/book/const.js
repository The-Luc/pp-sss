...
const _GETTERS = {
  ...
  TRIGGER_CLIP_ART_CHANGE: 'triggerClipArtChange'
};
...
export const GETTERS = {
  ...
  TRIGGER_CLIP_ART_CHANGE: `${MODULE_NAME}/${_GETTERS.TRIGGER_CLIP_ART_CHANGE}`
};
...
const _MUTATES = {
  ...
  ADD_OBJECT: 'addNewPrintObject',
  ADD_PRINT_BACKGROUND: 'addNewPrintBackground',
  UPDATE_TRIGGER_TEXT_CHANGE: 'updateTriggerTextChange',
  UPDATE_TRIGGER_BACKGROUND_CHANGE: 'updateTriggerBackgroundChange',
  DELETE_PRINT_OBJECT: 'deletePrintObject',
  UPDATE_TRIGGER_SHAPE_CHANGE: 'updateTriggerShapeChange',
  UPDATE_TRIGGER_CLIP_ART_CHANGE: 'updateTriggerClipArtChange'
};
...
export const MUTATES = {
  ...
  ADD_PRINT_BACKGROUND: `${MODULE_NAME}/${_MUTATES.ADD_PRINT_BACKGROUND}`,
  UPDATE_TRIGGER_BACKGROUND_CHANGE: `${MODULE_NAME}/${_MUTATES.UPDATE_TRIGGER_BACKGROUND_CHANGE}`,
  DELETE_PRINT_OBJECT: `${MODULE_NAME}/${_MUTATES.DELETE_PRINT_OBJECT}`,
  UPDATE_TRIGGER_SHAPE_CHANGE: `${MODULE_NAME}/${_MUTATES.UPDATE_TRIGGER_SHAPE_CHANGE}`,
  UPDATE_TRIGGER_CLIP_ART_CHANGE: `${MODULE_NAME}/${_MUTATES.UPDATE_TRIGGER_CLIP_ART_CHANGE}`
};
