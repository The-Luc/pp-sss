...
export const GETTERS = {
  ...
  GET_PAGE_INFO: `${MODULE_NAME}/${_GETTERS.GET_PAGE_INFO}`,
  DEFAULT_THEME_ID: `${MODULE_NAME}/${_GETTERS.DEFAULT_THEME_ID}`,
  TOTAL_OBJECT: `${MODULE_NAME}/${_GETTERS.TOTAL_OBJECT}`
};
...
export const MUTATES = {
  ...
  SET_PAGE_INFO: `${MODULE_NAME}/${_MUTATES.SET_PAGE_INFO}`,
  SET_STATUS_PAGE_NUMBER: `${MODULE_NAME}/${_MUTATES.SET_STATUS_PAGE_NUMBER}`,
  UPDATE_SPREAD_INFO: `${MODULE_NAME}/${_MUTATES.UPDATE_SPREAD_INFO}`,
  SET_PAGE_EMPTY: `${MODULE_NAME}/${_MUTATES.SET_PAGE_EMPTY}`
};
