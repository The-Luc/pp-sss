...
export const MUTATES = {
  ...
  SET_SUPPLEMENTAL_LAYOUT_ID: `${MODULE_NAME}/${_MUTATES.SET_SUPPLEMENTAL_LAYOUT_ID}`,
  ...
  REPLACE_SUPPLEMENTAL_FRAME: `${MODULE_NAME}/${_MUTATES.REPLACE_SUPPLEMENTAL_FRAME}`,
  MOVE_FRAME: `${MODULE_NAME}/${_MUTATES.MOVE_FRAME}`
};
